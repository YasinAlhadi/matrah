    ...
    <main className='max-w-md px-2 mx-auto'>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className='mb-6'>
          ...
          <input type="file" id="images" onChange={onChange} accept='.jpg,.png,.jpeg, .webp' multiple required className='w-full px-3 py-1.5 text-gray-700 bg-white border-gray-300 rounded transition duration-150 ease-in-out' />
        </div>
