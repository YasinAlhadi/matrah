      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form onSubmit={handleSubmit}>
            <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out mb-6' type="text" id='fullName' value={formData.fullName} onChange={handleChange} placeholder='Full Name' />
            ...
            <div className='relative mb-6'>
              <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out' type={showPassword ? "text" : "password"} id='password' value={password} onChange={handleChange} placeholder='Enter Your Password' />
              <span onClick={() => setShowPassword(!showPassword)}>{showPassword ? <IoIosEye className='absolute right-3 top-3 text-xl' /> : <IoIosEyeOff className='absolute right-3 top-3 text-xl' />}</span>
            </div>
            ...
            <button className='w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline uppercase transition duration-150 ease-out' type='submit'>Sign Up</button>
