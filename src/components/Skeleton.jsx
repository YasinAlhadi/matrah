...
export default function Skeleton() {
  return (
    ...
    </div><div className='animate-pulse flex flex-col justify-between items-center shadow-md hover:shadow-xl rounded-md overflow-hidden transition-shadow duration-150 m-[10px]'>
        <div className='contents'>
          <div className='h-[170px] w-full bg-gray-300 animate-pulse'></div>
          <div className="w-full p-[10px]">
            <div className="flex items-center space-x-1">
